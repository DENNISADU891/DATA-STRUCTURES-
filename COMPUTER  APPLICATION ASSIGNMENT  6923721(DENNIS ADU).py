#github.com/DENNISADU891
import numpy as np
L=12 #lenghth of beam(meters)
w=10 #intensity of load(kN/m)
#Question a
...
#for the minimum
min_M = min(M)
"""When the bending moment is min_M, we get an expression x**2 - Lx +(L**2//6)+(2*min_M)/ =0"""
a = 1 
b = -L 
c = (L**2//6)+(2*min_M)/w 
#Using the Almighty formula the two roots are; 
